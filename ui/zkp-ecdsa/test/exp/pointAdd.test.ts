...
export async function testPointAdd(curve: WeierstrassGroup = secp256k1): Promise<boolean> {
    const P1 = curve.generator().mul(curve.randomScalar()),
        P2 = curve.generator().mul(curve.randomScalar()),
        P3 = P1.add(P2),
        coordP1 = P1.toAffine(),
        coordP2 = P2.toAffine(),
        coordP3 = P3.toAffine()
